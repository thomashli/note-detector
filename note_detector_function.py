...
#from octave 0 to octave 8
	...
	'C#/D♭':		[17.32,34.65,69.3,138.59,277.18,554.37,1109,2217.46,4434.92],
	'D' : 		[18.35,36.71,73.42,146.83,293.66,587.33,1174.66,2349.3,4698.6],
	'D#/E♭' : 		[19.45,38.89,77.78,155.56,311.13,622.25,1244.5,2489.,4978.03],
	'E' : 		[20.60,41.2,82.41,164.81,329.63,659.25,1318.5,2637.,5274.04],
	'F' : 		[21.83,43.65,87.31,174.61,349.23,698.46,1396.9,2793.,5587.65],
	'F#/G♭' : 		[23.12,46.25,92.5,185.,369.99,739.99,1479.98,2959.,5919.91],
	'G' : 		[24.5,49.0,98.,196.,392.,784.,1568.,3135.96,6271.93],
	'G#/A♭' : 		[25.96,51.91,103.83,207.65,415.30,830.6,1661.2,3322.4,6644.88],
	'A' : 		[27.5,55.0,110.0,220.,440.,880.,1760.,3520.,7040.],
	'A#/B♭' : 		[14.568,29.135,58.270,116.541,233.082,466.164,932.328,1864.655,3729.310,7458.620],
...
def tuner(wav):
	...
	#find the note
	index = np.argmax(frequency_magnitude_spectrum)
